              ...
              <Row>
                <Col>
                  <hr className="my-5" style={{ 
                    borderTop: '4px solid rgba(203, 230, 130, 0.68).24)',
                    width: '70%',
                    margin: '3rem auto'
                  }} />
                </Col>
